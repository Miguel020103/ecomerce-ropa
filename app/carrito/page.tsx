    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="bg-gray-50 p-6 h-fit rounded-lg">
          ...
          {shipping > 0 && (
            <div className="mb-4 text-sm text-gray-600 bg-white border border-gray-200 rounded px-3 py-2">
              Te faltan <span className="font-medium text-gray-900">{formatPrice(remainingForFreeShipping)}</span> para envío gratis
            </div>
          )}
